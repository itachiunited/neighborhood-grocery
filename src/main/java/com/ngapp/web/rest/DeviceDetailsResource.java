...
import com.ngapp.repository.DeviceDetailsRepository;
import com.ngapp.repository.search.DeviceDetailsSearchRepository;
...
/**
 * REST controller for managing {@link com.ngapp.domain.DeviceDetails}.
 */
@RestController
@RequestMapping("/api")
public class DeviceDetailsResource {
    ...
    private static final String ENTITY_NAME = "neighborhoodDeviceDetails";
