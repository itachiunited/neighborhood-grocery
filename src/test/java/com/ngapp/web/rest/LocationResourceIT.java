...
public class LocationResourceIT {
     ...
     *
     * @see com.ngapp.repository.search.LocationSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    @Test
    public void checkLongitueIsRequired() throws Exception {
        int databaseSizeBeforeTest = locationRepository.findAll().size();
        // set the field null
        location.setLongitue(null);
